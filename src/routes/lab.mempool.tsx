...
export const Route = createFileRoute("/lab/mempool")({
  head: () => ({
    meta: [
      { title: "Mempool — Bitcoin Caveman Lab" },
      { name: "description", content: "A sala de espera do Bitcoin: transações pendentes, taxas e como mineradores escolhem o que entra no próximo bloco." },
    ],
  }),
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="mx-auto max-w-7xl w-full px-8 pt-16 pb-8">
        <div className="font-mono text-[11px] uppercase tracking-[0.3em] text-bitcoin mb-4">// módulo 02</div>
