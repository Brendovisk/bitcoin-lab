...
export const Route = createFileRoute("/lab/blockchain")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Visualize a blockchain do Bitcoin em tempo real: blocos, hashes, encadeamento e prova-de-trabalho." },
    ],
  }),
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="mx-auto max-w-7xl w-full px-8 pt-16 pb-8">
        <div className="font-mono text-[11px] uppercase tracking-[0.3em] text-bitcoin mb-4">// módulo 01</div>
      ...
      <section className="mx-auto max-w-7xl w-full px-8 mt-12 grid grid-cols-3 gap-4">
        <Concept n="hash" title="SHA-256 duplo" desc="Cabeçalho do bloco passa por SHA-256 duas vezes. O resultado precisa começar com N zeros." />
        <Concept n="nonce" title="Adivinhação massiva" desc="Mineradores variam um número até achar um hash válido. Bilhões de tentativas por segundo." />
        <Concept n="merkle" title="Raiz de Merkle" desc="Todas as transações do bloco são compactadas em uma única raiz — qualquer alteração muda tudo." />
      </section>
