    ...
    <div className="space-y-6">
      <div className="border border-border/70 bg-card/30 p-4 sm:p-6">
        ...
        <p className="mt-5 text-sm text-muted-foreground leading-relaxed">
          Essas 12 palavras <em>são</em> sua carteira. Quem tem essa lista, tem o Bitcoin. Anote em
          papel, guarde longe de câmeras, e nunca digite em um site qualquer.
        </p>
      </div>
        ...
        <>
          <div className="border border-border/70 bg-card/30 p-4 animate-fade-up sm:p-6">
            ...
            <p className="mt-3 text-sm text-muted-foreground">
              A xpub permite gerar todos os seus endereços <em>sem</em> revelar a chave privada.
              Útil pra ver saldo num computador inseguro.
            </p>
          </div>
          ...
          <div className="border border-border/70 bg-card/30 p-4 animate-fade-up sm:p-6">
            ...
            <p className="mt-3 text-sm text-muted-foreground">
              Uma única seed gera uma <span className="text-bitcoin">árvore infinita</span> de
              endereços. Use um diferente pra cada recebimento.
            </p>
          </div>
        </>
      )}
